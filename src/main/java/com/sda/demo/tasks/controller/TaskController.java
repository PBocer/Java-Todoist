...
public class TaskController {
    ...
    @RequestMapping("/com/sda/demo/tasks")
    ...
    public ModelAndView addNewTask(@ModelAttribute("task") Task task, ModelAndView modelAndView) {
    ...
    private ModelAndView prepareTaskList(ModelAndView modelAndView) {
        modelAndView.addObject("com/sda/demo/tasks", taskFacade.findAll());
